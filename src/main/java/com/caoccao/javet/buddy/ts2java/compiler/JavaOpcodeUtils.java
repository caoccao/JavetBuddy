...
public final class JavaOpcodeUtils {
    private static final Map<Integer, String> FRAME_TYPE_MAP = new HashMap<>();
    ...
    public static String getFrameTypeName(int opcode) {
        return FRAME_TYPE_MAP.getOrDefault(opcode, StringUtils.EMPTY);
    }

    public static String getOpcodeName(int opcode) {
        return OPCODE_MAP.getOrDefault(opcode, StringUtils.EMPTY);
    }

    public static int getOpposite(int opcode) {
        switch (opcode) {
