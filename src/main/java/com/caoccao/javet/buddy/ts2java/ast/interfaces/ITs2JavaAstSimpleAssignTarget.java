...
public interface ITs2JavaAstSimpleAssignTarget<AST extends ISwc4jAstSimpleAssignTarget, Memo extends Ts2JavaMemo>
        extends ITs2JavaAstAssignTarget<AST, Memo> {
}
